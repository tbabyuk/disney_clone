...
export const Footer = () => {
    return (
        <footer className="footer-section py-10 px-4 bg-[#FFFFFF]">
            ...
            <li className="ms-3 me-3"><a href="#" className="hover:text-[#1786EB]">Careers</a></li>
            <li className="ms-3 me-3"><a href="#" className="hover:text-[#1786EB]">Contact Us</a></li>
            <li className="ms-3 me-3"><a href="#" className="hover:text-[#1786EB]">Advertise With Us</a></li>
            <li className="ms-3 me-3"><a href="#" className="hover:text-[#1786EB]">Disney&reg; Premier Visa&reg; Card</a></li>
            </ul>
            <ul className="flex justify-center flex-wrap leading-6 text-[0.75rem] font-semibold mt-3">
            <li className="ms-3 me-3"><a href="#" className="hover:text-[#1786EB]">Terms of Use</a></li>
